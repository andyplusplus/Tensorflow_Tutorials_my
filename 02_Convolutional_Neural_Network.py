...
# ## TensorFlow Graph
# In[9]: # ### Helper-functions for creating new variables
...
# In[36]: # ## TensorFlow Run
session = tf.Session()

# In[37]: # ### Initialize variables
