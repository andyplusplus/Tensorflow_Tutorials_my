...
# deleted many line of functional model
...
layer_conv1 = model.layers[2] # In[50]: # The first convolutional layer has index 2.
layer_conv1

layer_conv2 = model.layers[4] # In[51]: # The second convolutional layer has index 4.
